...
public class ItaPontosRankedFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ita_pontos_ranked, container, false);

        //  Log.d("RONDA",getArguments().getString("jogador1"));

        j1 = (ToggleButton) rootView.findViewById(R.id.tBJ1R);
        j2 = (ToggleButton) rootView.findViewById(R.id.tBJ2R);
        j3 = (ToggleButton) rootView.findViewById(R.id.tBJ3R);
        j4 = (ToggleButton) rootView.findViewById(R.id.tbJ4R);
        j5 = (ToggleButton) rootView.findViewById(R.id.tBJ5R);
        p1 = (TextView) rootView.findViewById(R.id.tVJ1R);
        p2 = (TextView) rootView.findViewById(R.id.tVJ2R);
        p3 = (TextView) rootView.findViewById(R.id.tVJ3R);
        p4 = (TextView) rootView.findViewById(R.id.tVJ4R);
        p5 = (TextView) rootView.findViewById(R.id.tVJ5R);

        /*Button editar = (Button) rootView.findViewById(R.id.btnEditarR);
        editar.setOnClickListener(editarClickListener);
        buttonEffect(editar);*/

        Button reiniciar = (Button) rootView.findViewById(R.id.btnReiniciarItaR);
        reiniciar.setOnClickListener(reiniciarClickListener);
        buttonEffect(reiniciar);

        Button anular = (Button) rootView.findViewById(R.id.btnAnularItaR);
        anular.setOnClickListener(anularClickListener);
        buttonEffect(anular);

        Button soma1 = (Button) rootView.findViewById(R.id.btn1R);
        soma1.setOnClickListener(soma1ClickListener);
        buttonEffect(soma1);


        Button soma2 = (Button) rootView.findViewById(R.id.btn2R);
        soma2.setOnClickListener(soma2ClickListener);
        buttonEffect(soma2);

        Button soma4 = (Button) rootView.findViewById(R.id.btn4R);
        soma4.setOnClickListener(soma4ClickListener);
        buttonEffect(soma4);

        Button sub1 = (Button) rootView.findViewById(R.id.btnMenos1R);
        sub1.setOnClickListener(sub1ClickListener);
        buttonEffect(sub1);

        Button sub2 = (Button) rootView.findViewById(R.id.btnMenos2R);
        sub2.setOnClickListener(sub2ClickListener);
        buttonEffect(sub2);

        Button sub4 = (Button) rootView.findViewById(R.id.btnMenos4R);
        sub4.setOnClickListener(sub4ClickListener);
        buttonEffect(sub4);

        Button sair = (Button) rootView.findViewById(R.id.btnSairIR);
        buttonEffect(sair);
